...
#Use this model to show how you simply get the counts per number of obs years.smk. The exp(intercept) =the number of counts/7 (the number of obs in the 15-19 age group). We need to use the offset to get the number of counts/man-years in each age group
